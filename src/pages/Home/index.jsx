            ...
            <Col xs={24} sm={24} md={10} lg={16}>
              <div className="lg:w-[750px] sm:w-[1250px] ">
                ...
                <h1 className="font-poppins lg:text-[24px] sm:text-[8px] text-white">
                  Record your workouts and review your statistics. Join
                  challenges to get motivated – push your limits. Share your
                  success with a global community and reach your goals with
                  every step.
                </h1>
              </div>
            </Col>
            <Col xs={12} sm={12} md={6} lg={8}>
              <div className="w-[350px]">
                ...
                <span className=" text-white lg:text-[1.2em] sm:text-[0.6em] font-poppins leading-[1em] ">
                  Our yoga trainers will build your perfect body workout ever
                  and physique professionals.
                </span>
              </div>
            </Col>
          </Row>
          <Row className=" lg:pb-0 lg:px-[120px] sm:pt-[200px] sm:pb-0 sm:px-[20px]">
            ...
            <Col xs={24} sm={24} md={10} lg={16}>
              <div className="lg:w-[750px] sm:w-[1250px] pt-[20px]">
                ...
                <br />
                <h1 className="font-poppins lg:text-[24px] sm:text-[8px] text-white">
                  Select muscle groups and create your own workout that fits
                  your schedule Join challenges: compare your activity to others
                  and push yourself in new ways. Workout anywhere, any time.
                </h1>
              </div>
            </Col>
          </Row>
          ...
          <Row className=" lg:pb-0 lg:px-[120px] sm:pt-[200px] sm:pb-0 sm:px-[20px]">
            ...
            <Col xs={24} sm={24} md={10} lg={16}>
              <div className="lg:w-[750px] sm:w-[1250px] ">
                ...
                <br />
                <h1 className="font-poppins lg:text-[24px] sm:text-[8px] text-white">
                  Share your success with a global community and reach your
                  goals with every step.
                </h1>
              </div>
            </Col>
          </Row>
